...
const FRAGMENT_SHADER = `
  ...
  void main(void) {
    ...
    float opacity = clamp((90.0 - dist) / 180.0, 0.0, 1.0) * 0.75;
    // Cyan-blue accent matching ProcureGuard palette
    vec3 color = mix(vec3(0.05, 0.45, 0.85), vec3(0.15, 0.85, 0.95), opacity);
